	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		...
		<div class="container">
			...
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input class="form-control" type="hidden" name="classId" value="${c.classId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">班级名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="className" value="${c.className}" placeholder="请输入班级名称"  onblur="blurckName(this.value)"/>
						</div>
					</div>
					<div class="form-group">
...
function doSub(){
	...
	bootbox.confirm("确认提交保存吗？",function(r){
		if(r){
			$.ajax({
				type: "post", //请求方式
				url :"<%=ctx%>/classs/edit.action",  //请求路径
